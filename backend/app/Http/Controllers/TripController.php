...
class TripController extends Controller
{
    ...
    public function accept(Request $request, Trip $trip)
    {
        ...
        /**
         * so when ever this event is dispatched it creates a new trip accepted object
         * From TripAccepted class passes the $trip to the constructor adds it the to public property
         * and it will broadcasted out
         */
        //dd($request->user());
